    ...
    <div className="w-full">
      ...
      <section className="bg-slate-900 text-white py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-1 text-center md:text-left">
          <span className="text-xs font-bold text-accent-purple uppercase tracking-widest block mb-2">Connect with us</span>
          <h1 className="text-4xl font-extrabold tracking-tight text-white drop-shadow-md">Contact Us</h1>
